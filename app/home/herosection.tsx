...
const HeroSection = () => {
  return (
    <section
      ...
      style={{
        backgroundImage:
          "url('https://i.ibb.co/2Y1vj15/photo-2025-01-18-12-05-31.jpg')",
        backgroundSize: "cover",
        backgroundPosition: "center",
      }}
    >
      <div className="bg-black absolute top-0 left-0 inset-0 opacity-45 rounded-lg" />
      <div className="text-center bg-opacity-50 p-6 rounded-lg max-w-3xl py-24 z-10">
        ...
        <div className={subtitle({ class: "mt-4 italic text-light" })}>
          ...
          light where the dark feelings grow. With respect for the fallen and
          love for their art, they shatter the stigma and heal every heart”
        </div>
