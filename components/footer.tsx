        ...
        <footer className="bg-gray-100 dark:bg-neutral-900">
            <div className="container mx-auto max-w-7xl px-6 py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-8">
                    {/* About Section */}
                    <div>
                        <h2 className="text-lg font-bold mb-4">EMBALMERS’ UNMASKED THE TRUTH BEHIND THEIR PROFESSION</h2>
                        ...
                        <div className="text-left">
                            ...
                            <div className="flex flex-col gap-4">
                                <ul className="text-sm max-w-xl break-words text-gray-600 list-disc">
                                    ...
                                    {/* New References */}
                                    <li>
                                        <Link className="hover:text-blue-600" href="https://www.purereflections.ie/post/explanation-of-the-embalming-process">
                                            https://www.purereflections.ie/post/explanation-of-the-embalming-process
                                        </Link>
                                    </li>
                                    <li>
                                        <Link className="hover:text-blue-600" href="https://www.onlinedegree.com/careers/trade/embalmer/">
                                            https://www.onlinedegree.com/careers/trade/embalmer/
                                        </Link>
                                    </li>
                                    <li>
                                        <Link className="hover:text-blue-600" href="https://www.ziprecruiter.com/career/Embalmer/What-Is-How-to-Become">
                                            https://www.ziprecruiter.com/career/Embalmer/What-Is-How-to-Become
                                        </Link>
                                    </li>
                                    <li>
                                        <Link className="hover:text-blue-600" href="https://www.serenitycasket.com.sg/embalmer-frequently-asked-questions/">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-sm text-gray-500">
                        <a href="">
                            Create and Design by: Giolo Evora
                        </a>
                    </p>
